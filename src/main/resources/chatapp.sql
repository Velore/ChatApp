...
# 插入群组数据
INSERT INTO
    chat_group(gid, owner_id, group_name, establish_time) VALUES('10001', 'u1', 'name10001', '2001-01-01 00:00:05');
INSERT INTO
    chat_group(gid, owner_id, group_name, establish_time) VALUES('10002', 'u4', 'name10002', '2001-01-01 00:00:10');
INSERT INTO
    chat_group(gid, owner_id, group_name, establish_time) VALUES('12345', 'u1', 'name12345', '2001-01-01 00:00:15');

# 插入群组成员数据
INSERT INTO
    group_member(gid, member_id, member_auth, join_time) VALUES('10001', 'u1', 'owner', '2001-01-02 00:00:00');
INSERT INTO
    group_member(gid, member_id, member_auth, join_time) VALUES('12345', 'u1', 'owner', '2001-01-02 00:00:00');
INSERT INTO
    group_member(gid, member_id, member_auth, join_time) VALUES('10002', 'u4', 'owner', '2001-01-02 00:00:00');
INSERT INTO
    group_member(gid, member_id, member_auth, join_time) VALUES('10001', 'u2', 'member', '2001-01-02 00:00:00');
INSERT INTO
    group_member(gid, member_id, member_auth, join_time) VALUES('10001', 'u3', 'member', '2001-01-02 00:00:00');
INSERT INTO
    group_member(gid, member_id, member_auth, join_time) VALUES('10001', 'u4', 'member', '2001-01-02 00:00:00');
INSERT INTO
    group_member(gid, member_id, member_auth, join_time) VALUES('10002', 'u5', 'member', '2001-01-02 00:00:00');
INSERT INTO
    group_member(gid, member_id, member_auth, join_time) VALUES('12345', 'u6', 'member', '2001-01-02 00:00:00');